      ...
      <div className="w-full">
        <div className="grid justify-between grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div className="grid justify-between grid-cols-3 gap-4">
            <ul className="text-muted-foreground">
              <p className="block mb-1 text-base font-semibold text-foreground">
                Help
              </p>
              <li>
                <a
                  href="/"
                  className="block py-1 hover:text-muted-foreground/80 text-sm"
                >
                  Get Help
                </a>
              </li>
              <li>
                <a href="/" className="block text-sm py-1">
                  Order Status
                </a>
              </li>
              <li>
        ...
        <div className="flex flex-col items-center justify-center w-full py-4 mt-12 border-t border-slate-200 md:flex-row md:justify-between">
          <p className="block mb-4 text-sm text-center text-muted-foreground md:mb-0">
            Copyright © 2026 StepUp. All Rights Reserved.
          </p>
